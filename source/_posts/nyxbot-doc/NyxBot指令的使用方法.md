...
| 仲裁表       |                    仲裁表                    | 有价值的仲裁任务列表, **注意：此指令在 [2.1.4](https://github.com/KingPrimes/NyxBot/releases)中被从 ~~仲裁Ex~~ 修改成了 仲裁表** |   普通用户   |
...
| 希图斯       |                    希图斯                    |                                             查询希图斯中的赏金任务                                             |   普通用户   |
| 英择谛       |                    英择谛                    |                                             查询英择谛中的赏金任务                                             |   普通用户   |
| 索拉里斯      |                   索拉里斯                    |                                            查询索拉里斯中的赏金任务                                             |   普通用户   |
